...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/local_library_white_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.lib_btn.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/event_seat_white_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.room_btn.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/book_white_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.book_btn.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/people_white_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.readers_btn.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/pan_tool_white_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.is_btn.setIcon(icon5)
